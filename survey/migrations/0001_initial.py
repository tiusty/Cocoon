    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commute_type', models.IntegerField(default=2)),
        ...
        migrations.CreateModel(
            name='RentScoringStruct',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('score', models.IntegerField(default=0)),
                ('score_possible', models.IntegerField(default=0)),
                ('eliminated', models.BooleanField(default=False)),
                ('house', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='houseDatabase.RentDatabase')),
            ],
        ),
        migrations.CreateModel(
