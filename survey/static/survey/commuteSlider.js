...
$( function() {
    $( "#commute" ).slider({
        ...
        slide: function( event, ui ) {
            ...
            $( "#id_min_commute_survey").val(ui.values[0]);
            $( "#id_max_commute_survey").val(ui.values[1]);
        }
    });
    // If the ui value goes above 61 then start recording in hours
    ...
    $( "#id_min_commute_survey").val( $("#commute").slider("values", 0));
    $( "#id_max_commute_survey").val( $("#commute").slider("values", 1));
} );