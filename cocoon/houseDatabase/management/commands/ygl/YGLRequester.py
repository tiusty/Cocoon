...
from cocoon.houseDatabase.models import ListingManagementModel, HomeTypeModel, HomeProviderModel
...
class YGLRequester(object):
    ...
    def parse_idx_feed(self):
        ...
        manager = ListingManagementModel.objects.all().first()
        manager.last_updated_listings = self.update_timestamp
        manager.save()
